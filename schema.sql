...
INSERT INTO saves (user_id , proj_id ) VALUES (SELECT u.user_id FROM users u WHERE u.username = 'test' UNION ALL SELECT p.proj_id FROM project p WHERE p.pname = 'test');
